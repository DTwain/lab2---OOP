...
void test_filters_on_tranzactions_serv() {
	...
	assert(copie4 -> arr_of_tranzactions[0].day == 5);
	assert(copie4 -> arr_of_tranzactions[0].sum == 500);
	assert(strcmp(copie4 -> arr_of_tranzactions[0].type, "intrare\n") == 0);
	assert(strcmp(copie4 -> arr_of_tranzactions[0].description, "imprumut\n") == 0);
